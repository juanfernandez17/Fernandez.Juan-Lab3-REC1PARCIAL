...
const armas = (localStorage.getItem("armas")).split(',');                       // Obtiene del localStorage las armas/tipos de monstruos almacenados
const loader = document.querySelector("#loader");     
const $opcionesOrdenamiento = document.getElementById("opcionesOrdenamiento");
const listaCriteriosOrdenamiento = (localStorage.getItem("metodosDeOrdenamiento")).split(",");  // Obtiene del localStorage los criterios de ordenamiento almacenados                          
...
const $pDialogAccion = document.getElementById("pDialogAccion");
const $dialogo = document.getElementById("newDialog");

let confirmacionDialog = true;
